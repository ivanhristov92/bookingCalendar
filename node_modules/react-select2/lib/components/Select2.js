...
var Select2 = function (_Component) {
  ...
  _createClass(Select2, [{
    ...
    value: function initSelect2() {
      ...
      this.el = (0, _jquery2.default)(this.refs.select);
    ...
    value: function makeOption(item, k) {
      if (this.isObject(item)) {
        ...
        var filteredAttributes = this.filterAttributes(itemParams);
        return _react2.default.createElement(
          'option',
          _extends({ key: 'option-' + k, value: id }, filteredAttributes),
          text
        );
      }
    ...
    value: function filterAttributes(attributes) {
      var filteredAttributes = {};

      for (var name in attributes) {
        if (_DOMProperty2.default.properties.hasOwnProperty(name) || _DOMProperty2.default.isCustomAttribute(name) || _EventPluginRegistry2.default.registrationNameModules.hasOwnProperty(name)) {
    ...
    value: function render() {
      ...
      var filteredAttributes = this.filterAttributes(params);
      return _react2.default.createElement(
        'select',
        _extends({ ref: 'select' }, filteredAttributes),
